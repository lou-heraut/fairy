...
![](https://img.shields.io/github/last-commit/louis-heraut/fairy)
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](code_of_conduct.md) 
<!-- badges: end -->

**fairy** is a messy package that gathers various useful tools (at least for me) for reading, analyzing, and writing hydrological and environmental data in R in a FAIR paradigm.
...
``` r
remotes::install_github('louis-heraut/fairy')
```
...
Feel free to [open an issue](https://github.com/louis-heraut/fairy/issues) ! I’m actively maintaining this project, so I’ll do my best to respond quickly.  
I’m also reachable on my institutional INRAE [email](mailto:louis.heraut@inrae.fr?subject=%5Bfairy%5D) for more in-depth discussions.
...
🚀 — **Want to contribute ?**  
If you don't know where to start, [open an issue](https://github.com/louis-heraut/fairy/issues).

If you want to try by yourself, why not start by also [opening an issue](https://github.com/louis-heraut/fairy/issues) to let me know you're working on something ? Then:
