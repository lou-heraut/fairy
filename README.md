...
![](https://img.shields.io/github/last-commit/lou-heraut/fairy)
...
``` r
remotes::install_github('lou-heraut/fairy')
```
...
Feel free to [open an issue](https://github.com/lou-heraut/fairy/issues) ! I’m actively maintaining this project, so I’ll do my best to respond quickly.  
...
🚀 — **Want to contribute ?**  
If you don't know where to start, [open an issue](https://github.com/lou-heraut/fairy/issues).

If you want to try by yourself, why not start by also [opening an issue](https://github.com/lou-heraut/fairy/issues) to let me know you're working on something ? Then:
